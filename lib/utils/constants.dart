...
class Constants{
  ...
  static const String ShowAll = 'All prints';
  static const String ShowAvailable = 'Available prints';
  static const String ShowFinished = 'Prints out of Stock';
...
const kTextFieldDecoration = InputDecoration(
  ...
  enabledBorder: OutlineInputBorder(
    borderSide: BorderSide(color: Color(0XFFA6277C), width: 1.0),
    borderRadius: BorderRadius.all(Radius.circular(8.0)),
  ),
  focusedBorder: OutlineInputBorder(
    borderSide: BorderSide(color: Color(0XFFA6277C), width: 2.0),
    borderRadius: BorderRadius.all(Radius.circular(8.0)),
  ),
);
